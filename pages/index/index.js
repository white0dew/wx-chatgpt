            ...
            var e = {
                data: function () {
                    return {
                        ...
                        msgList: [{
                            my: !1,
                            msg: "你好! 我是你的专属AI助手，你想问什么呢？使用人数过多,请耐心等待哦"
                        }],
                        msgContent: "",
                        msg: "",
                        userInfo: {
                ...
                onLoad: function () {
                    var s = this;
                    var value = "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";//修改成你自己的url即可
                    try {
                        wx.showShareMenu({
                            withShareTicket: true,
                            //设置下方的Menus菜单，发送给朋友与分享到朋友圈两个按钮可以点击
